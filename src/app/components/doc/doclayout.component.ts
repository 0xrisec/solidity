...
import { faBars, faBox, faBugs, faChessPawn, faCircleArrowUp, faF, faHandsPraying, faInfo, faSignsPost, faXmark, faMap, faFileAlt } from '@fortawesome/free-solid-svg-icons';
